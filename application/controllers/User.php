...
class User extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('user/tbl_user_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'password' => $row->password,
            ...
            $this->load->view('user/tbl_user_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->load->view('user/tbl_user_form', $data);
    }
...
/* Generated by Harviacode Codeigniter CRUD Generator 2018-07-15 00:10:57 */
/* http://harviacode.com */