...
<html>
    ...
    <body>
		...
		<th>Action</th>
			...
			<td><?php echo $dokter->jenis_dokter ?></td>
			...
			<td style="text-align:center" width="200px">
				...
				echo ' | '; 
				echo anchor(site_url('dokter/update/'.$dokter->id_dokter),'Update'); 
				echo ' | '; 
				echo anchor(site_url('dokter/delete/'.$dokter->id_dokter),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
